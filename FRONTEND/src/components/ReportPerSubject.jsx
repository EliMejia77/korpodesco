                    ...
                    <Card>
                        ...
                        <h6 className='p-4 mx-auto'>
                           <h5>Saludos Cordiales,</h5><br/>
                            ...
                            <p>En el presente reporte se informa que el promedio general de los estudiantes en la materia: {materia}, durante este año lectivo en Corporación de educación laboral KORPODESCO es de <b>{promFinal}</b>.<br/></p>
